...
CREATE TABLE Amigo(cd_amigo integer primary key, cd_email_amigo text, cd_telefone text, fk_Usuario integer, FOREIGN KEY (fk_Usuario) REFERENCES Usuario(cd_usuario));
